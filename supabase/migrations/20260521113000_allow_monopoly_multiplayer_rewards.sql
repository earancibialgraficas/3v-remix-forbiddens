-- Permite que Monopolio Arcade use puntos STAT, boosters y leaderboard multiplayer.
...
BEGIN
  ...
  IF p_game_slug NOT IN (
    'pong', 'agar', 'voidstrike', 'tosios', 'monopoly', 'tic-tac-toe', 'card-duel', 'chess', 'massive-decks', 'watch-together',
  ...
  display_game_name := CASE p_game_slug
    ...
    WHEN 'tosios' THEN 'TOSIOS'
    WHEN 'monopoly' THEN 'Monopolio Arcade'
