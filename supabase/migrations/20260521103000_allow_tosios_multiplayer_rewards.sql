-- Permite que TOSIOS use puntos STAT, boosters y leaderboard multiplayer.
...
BEGIN
  ...
  IF p_game_slug NOT IN (
    'pong', 'agar', 'voidstrike', 'tosios', 'tic-tac-toe', 'card-duel', 'chess', 'massive-decks', 'watch-together',
