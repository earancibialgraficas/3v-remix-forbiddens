...
export const PROFILE_TRANSITIONS: Record<ProfileTransitionSlug, ProfileTransitionTheme> = {
  fuego_infernal: {
    ...
    thumbnailUrl: '/shop-thumbnails/fuego-infernal.png',
    price: 5000,
    priceType: 'fcoins',
    durationMs: 2400,
  },
  varita_magica: {
    ...
    thumbnailUrl: '/shop-thumbnails/varita-magica.png',
    price: 5000,
    priceType: 'fcoins',
    durationMs: 7000,
  },
  boomshacka: {
    ...
    thumbnailUrl: '/shop-thumbnails/boomshacka-v1.png',
    price: 5000,
    priceType: 'fcoins',
    durationMs: 6000,
    fadeInMs: 500,
  ...
  boomshacka_v2: {
    ...
    thumbnailUrl: '/shop-thumbnails/boomshacka-v2.png',
    price: 5000,
    priceType: 'fcoins',
    durationMs: 6000,
    fadeInMs: 500,
