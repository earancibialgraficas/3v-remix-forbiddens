...
export const DEMONIACO_SKIN: SkinTheme = {
  ...
  patterns: {
    ...
    panel: "linear-gradient(rgba(8, 8, 8, 0.9), rgba(6, 6, 6, 0.96)), url('/skins/demoniaco/backgrounds/solid/window-rock.png') center / cover, linear-gradient(135deg, #13100e, #060606)",
    ...
    profileSurface: "linear-gradient(rgba(7, 7, 7, 0.88), rgba(5, 5, 5, 0.94)), url('/skins/demoniaco/backgrounds/solid/window-rock.png') center / cover",
