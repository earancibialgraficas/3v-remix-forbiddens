...
export default function GameBubble() {
  ...
  useEffect(() => {
    ...
    const canvas = canvasRef.current;
    if (canvas) {
      canvas.tabIndex = 0; // Hacer el canvas focusable para recibir eventos de teclado
    ...
    <>
        ...
        >
          <div className={cn("relative flex-1 min-w-0", minimized ? "h-full w-full" : "flex flex-col")}>
            ...
            <div
              ...
              className={cn("relative bg-black overflow-hidden", minimized ? "h-full w-full" : "flex-1")}
            >
              {!romLoaded && (
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-1.5">
                    <div className="flex items-end justify-between gap-2">
                      <div className="min-w-0">
                        <p className="text-[8px] font-body text-foreground truncate font-medium">
                          {activeGame.gameName}
                        </p>
              ...
              <div className="w-14 bg-muted/30 border-l border-border flex flex-col items-center py-3 gap-2 shrink-0">
                ...
                <div className="relative">
                  <Button
                    ...
                    className="h-10 w-10 text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded-lg"
                    title="Volumen"
                  >
      ...
      {showSaveDialog && (
        ...
        >
          ...
          <div
            className="relative bg-card border border-neon-green/30 rounded-lg p-5 w-80 animate-scale-in"
      ...
      {showLoadDialog && (
        ...
        >
          <div className="absolute inset-0 bg-black/60" />
          <div
            className="relative bg-card border border-neon-cyan/30 rounded-lg p-5 w-80 max-h-[60vh] flex flex-col animate-scale-in"
            onClick={(e) => e.stopPropagation()}
          >
