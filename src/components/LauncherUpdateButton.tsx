...
const RECOMMENDED_LAUNCHER_VERSION = "0.1.9";
const MANUAL_LAUNCHER_DOWNLOAD_URL = "https://sbnwrrrachptwfrgjylv.supabase.co/storage/v1/object/public/launcher-downloads/FORBIDDENS_0.1.9_x64-setup.exe";
