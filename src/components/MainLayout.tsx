    ...
    <div className="flex bg-background text-foreground w-full min-h-screen relative overflow-x-hidden">
      ...
      {!mobileSidebarOpen && (
        <div className="md:hidden fixed top-2 left-2 z-[60]">
          <Button variant="secondary" size="icon" className="h-9 w-9 bg-card border border-border shadow-xl" onClick={() => setMobileSidebarOpen(true)}>
      ...
      {mobileSidebarOpen && (
        <div className="md:hidden fixed inset-0 z-[100] flex transition-all duration-300">
          ...
          <div className="relative top-0 left-0 h-full w-64 bg-card shadow-2xl animate-in slide-in-from-left duration-300">
