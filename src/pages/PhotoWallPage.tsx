...
const jellyStyles = `
  ...
  .animate-jelly-safe {
    animation: jelly-pop-safe 0.6s cubic-bezier(0.25, 1, 0.5, 1) forwards;
  }
`;
...
function ExpandedPhotoCard({ photo, onClose, onReaction, onHide, onSave, userReaction, isStaff, limits }: any) {
  ...
  return (
    <div 
      className={cn(
        "w-full bg-card rounded-xl flex flex-col md:flex-row overflow-hidden animate-jelly-safe",
